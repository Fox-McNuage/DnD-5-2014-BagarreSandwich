...
class Sort_zone_carré:
    ...
    def draw(self):
        pyglet.shapes.Rectangle(self.position[0], self.position[1], self.longueur, self.largueur, color=(255, 153, 51, 100))
...
class Sort_zone_cercle:
    ...
    def draw(self):
        pyglet.shapes.Circle(self.position[0], self.position[1], self.rayon, color=(255, 153, 51, 100))
