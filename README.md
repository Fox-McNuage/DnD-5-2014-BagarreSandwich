...
2. rajouter les sorts à effet de zone que je peux placer dans la portée possible. Et si jamais ils déplacent des creatures ou modifient le terrain
3.  il faut le prendre en compte la taille des perso et leur allonge, ainsi que l'impossibilité de se traverser est aussi à ajouter.
